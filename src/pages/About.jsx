    ...
    return(
        <div className="AboutPage">
            <div className='AboutMe'>
               ...
               <div>
               Hello! I'm Kan, 20 yrs old, a Software Engineer based in <span className="Span">New York, NY</span>. Over the last 3 years, I have been programming as a hobby creating games and scripts that automate simple tasks. 
                <br></br>
                <br></br>
